...
for(rep in 1:repetitions)
{
  ...
  responseObjective <- apply(design, 1, Objective) #simulator responses
  responseConstraint1 <- apply(design, 1, Constraint1) #simulator responses
  responseConstraint2 <- apply(design, 1, Constraint2) #simulator responses
